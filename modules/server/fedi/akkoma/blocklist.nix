{
  ...
  reject = [
    ...
    ["void.rehab" "blocked by isp, phisically impossible to federate with"]
    ["ouroboros.gay" "blocked by isp, phisically impossible to federate with"]
  ];

  followers_only = [
    ["bird.makeup" "twitter mirror"]
  ];
}
