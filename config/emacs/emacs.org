    ...
    (setq mu4e-contexts
      	(list
      	 ...
      	 (make-mu4e-context
      	  ...
      	  :vars `((user-mail-address . (lambda () (cdr (assoc 'outlook sakomacs-mail-accounts))))
      	          (user-full-name . "Sako")
      	 ...
      	 (make-mu4e-context
      	  ...
      	  :vars `((user-mail-address . (lambda () (cdr (assoc 'protonmail sakomacs-mail-accounts))))
      	          (user-full-name . "Sako")
    	 ...
    	 (make-mu4e-context
    	  ...
    	  :vars `((user-mail-address .  (lambda () (cdr (assoc 'gmail-1 sakomacs-mail-accounts))))
    		  (user-full-name . "Sako")
    	 ...
    	 (make-mu4e-context
    	  ...
    	  :vars `((user-mail-address . (lambda () (cdr (assoc 'gmail-2 sakomacs-mail-accounts))))
    		  (user-full-name . "Sako")
